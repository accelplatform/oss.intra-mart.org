...
<%@ page import="sample.shopping.controller.service.CartEmptyException" %>

<imartj2ee:HelperBean id="bean" class="org.intra_mart.framework.base.web.bean.ErrorHelperBean" />

<%
	CartEmptyException exception = (CartEmptyException)bean.getException();
%>
...
<!-- 再チャレンジのためのコード -->
<imartj2ee:Form application="sample.shopping.conf.shopping" service="cart_empty_back" method="POST" name="nextpage">
