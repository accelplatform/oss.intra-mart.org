...
<%@ page import="sample.shopping.controller.service.ValueLengthException" %>

<imartj2ee:HelperBean id="bean" class="org.intra_mart.framework.base.web.bean.ErrorHelperBean" />

<%
	ValueLengthException exception = (ValueLengthException)bean.getException();
%>
					...
					<TH nowrap bgcolor="Pink">
						&nbsp;&nbsp;&nbsp;&nbsp;
							<FONT size="4" color="Crimson">
								「<%= exception.getPrameterName() %>」が<%= exception.getMessage() %>
							</FONT>
						&nbsp;&nbsp;&nbsp;&nbsp;
					</TH>
				</TR>
