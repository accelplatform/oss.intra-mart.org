...
<HTML>
<HEAD>
	<TITLE><imartj2ee:Message application="sample.shopping.conf.shopping" key="info.thanks" /></TITLE>
</HEAD>
					...
					<TH nowrap bgcolor="Pink">
						&nbsp;&nbsp;&nbsp;&nbsp;
							<FONT size="4" color="Crimson">
								<imartj2ee:Message application="sample.shopping.conf.shopping" key="info.thanks" />
							</FONT>
						&nbsp;&nbsp;&nbsp;&nbsp;
					</TH>
				</TR>
...
<!-- Next -->
<imartj2ee:Form application="sample.shopping.conf.shopping" service="buyer_thankyou_next" method="POST">
