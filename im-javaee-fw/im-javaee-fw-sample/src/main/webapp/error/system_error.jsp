...
<%@ page import="org.intra_mart.framework.system.exception.SystemException" %>
<%@ page import="java.io.PrintWriter" %>

<imartj2ee:HelperBean id="bean" class="org.intra_mart.framework.base.web.bean.ErrorHelperBean" />

<%
    SystemException exception = (SystemException)bean.getException();
%>

<HTML>
<HEAD>
    <TITLE>システム処理エラーページ</TITLE>
		<STYLE type="text/css">
		<!--
		.contntClass {
			font-size: 12px;
