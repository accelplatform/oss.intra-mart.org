...
Class("im.lang.IllegalArgumentException").extend("im.lang.RuntimeException").define(
	/**
	 ...
	 * @version 0.1
	 */
	im.lang.IllegalArgumentException = function (message, cause) {
		/* constructor */
		{
			this.superclass(message, cause);
			this.name = im.lang.IllegalArgumentException.clazz.getName();
		}
	}
);
