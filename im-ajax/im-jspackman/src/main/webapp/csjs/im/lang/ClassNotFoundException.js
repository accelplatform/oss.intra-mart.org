...
Class("im.lang.ClassNotFoundException").extend("im.lang.Exception").define(
	/**
	 ...
	 * @version 0.1
	 */
	im.lang.ClassNotFoundException = function (message, cause) {
		/* constructor */
		{
			this.superclass(message, cause);
			this.name = im.lang.ClassNotFoundException.clazz.getName();
		}
	}
);
