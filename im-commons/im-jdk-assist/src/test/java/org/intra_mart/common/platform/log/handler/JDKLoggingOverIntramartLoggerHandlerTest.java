...
public class JDKLoggingOverIntramartLoggerHandlerTest extends TestCase {
	
	@Override
	protected void setUp() throws Exception {
		super.setUp();

		System.setProperty(JDKLoggingOverIntramartLoggerHandler.class.getCanonicalName() + ".enablePrintStackTrace", "true");
