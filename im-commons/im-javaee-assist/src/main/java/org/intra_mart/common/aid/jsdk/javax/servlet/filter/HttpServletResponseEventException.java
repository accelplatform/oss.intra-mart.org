 ...
 */
public class HttpServletResponseEventException extends ExtendedServletException{
	/**
	 * 詳細メッセージを null にして、新規例外を構築します。
	 * このコンストラクタでは原因を初期化しません。
	 */
	public HttpServletResponseEventException(){
		super();
	}
	 ...
	 */
	public HttpServletResponseEventException(String message){
		super(message);
	}
	 ...
	 */
	public HttpServletResponseEventException(String message, Throwable cause){
		super(message, cause);
	}
	 ...
	 * @param cause 原因 ({@link java.lang.Throwable#getCause()} メソッドによる取得用に保存される)。null 値が許可される。null 値は原因が存在しないか未知であることを示す
	 */
	public HttpServletResponseEventException(Throwable cause){
		super(cause);
	}
}
