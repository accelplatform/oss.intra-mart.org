 ...
 * 
 */
public class HttpServletResponseEventFilterException extends HttpServletResponseEventException{
	/**
	 * 詳細メッセージを null にして、新規例外を構築します。
	 * このコンストラクタでは原因を初期化しません。
	 */
	public HttpServletResponseEventFilterException(){
		super();
	}
	 ...
	 */
	public HttpServletResponseEventFilterException(String message){
		super(message);
	}
	 ...
	 */
	public HttpServletResponseEventFilterException(String message, Throwable cause){
		super(message, cause);
	}
	 ...
	 * @param cause 原因 ({@link java.lang.Throwable#getCause()} メソッドによる取得用に保存される)。null 値が許可される。null 値は原因が存在しないか未知であることを示す
	 */
	public HttpServletResponseEventFilterException(Throwable cause){
		super(cause);
	}
}
